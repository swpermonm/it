! function() {
    var t = function(t) {
            ...
            var y = "prototype",
                v = function(t, n, e) {
                    var r, o, i, u, c = t & v.F,
                        ...
                        p = s ? B : B[n] || (B[n] = {}),
                        h = p[y] || (p[y] = {});
                    for (r in s && (e = n), e) i = ((o = !c && d && d[r] !== undefined) ? d : e)[r], u = l && o ? I(i, T) : a && "function" == typeof i ? I(Function.call, i) : i, d && L(d, r, i, t & v.U), p[r] != i && E(p, r, u), a && h[r] != i && (h[r] = i)
                };
        ...
        G = t(function(t) {
            ...
            t.exports = Object.create || function c(t, n) {
                var e;
                return null !== t ? (o[i] = h(t), e = new o, o[i] = null, e[r] = t) : e = u(), n === undefined ? e : U(e, n)
            }
        }),
        H = t(function(t) {
            var r = y.f,
        ...
        W = t(function(t) {
            ...
            t.exports = function(t, n, o, e, r, i, u) {
                ...
                if (b && (f = V(b.call(new t))) !== Object.prototype && f.next && (H(f, l, !0), M || O(f, w) || E(f, w, P)), d && y && y.name !== S && (p = !0, v = function _() {
                        return y.call(this)
                    }), M && !u || !x && !p && h[w] || E(h, w, v), D[n] = v, D[l] = P, r)
                    if (c = {
                            values: d ? v : a(S),
                            keys: i ? v : a(A),
                            entries: m
        ...
        et = t(function(t) {
            ...
            i && u || (i = function h(t) {
                ...
                s.now(I(d, t, 1))
            } : c ? (e = (n = new c).port2, n.port1.onmessage = p, r = I(e.postMessage, e, 1)) : T.addEventListener && "function" == typeof postMessage && !T.importScripts ? (r = function(t) {
                T.postMessage(t + "", "*")
        ...
        ot = t(function(t) {
            ...
            function n(t) {
                ...
                this.promise = new t(function(t, n) {
                    ...
                    e = t, r = n
                }), this.resolve = C(e), this.reject = C(r)
            }
        ...
        at = (t(function() {
                    ...
                    if (!a._n) {
                        ...
                        i(function() {
                            for (var s = a._v, f = 1 == a._s, t = 0, n = function(t) {
                                    var n, e, r = f ? t.ok : t.fail,
                                        o = t.resolve,
                                        i = t.reject,
                                        u = t.domain;
                                    try {
                                        r ? (f || (2 == a._h && b(a), a._h = 1), !0 === r ? n = s : (u && u.enter(), n = r(s), u && u.exit()), n === t.promise ? i(l("Promise-chain cycle")) : (e = h(n)) ? e.call(n, o, i) : o(n)) : i(s)
                                    } catch (c) {
                                        i(c)
                                    }
                                }; r.length > t;) n(r[t++]);
                ...
                v = function(i) {
                    t.call(T, function() {
                        ...
                        if (o && (t = it(function() {
                            ...
                            }), i._h = f || m(i) ? 2 : 1), i._a = undefined, o && t.e) throw t.v
                    })
                },
                m = function(t) {
                    if (1 == t._h) return !1;
            ...
            p || (s = function x(t) {
                ...
                then: function A(t, n) {
                    var e = d(tt(this, s));
                    return e.ok = "function" != typeof t || t, e.fail = "function" == typeof n && n, e.domain = f ? c.domain : undefined, this._c.push(e), this._a && this._a.push(e), this._s && y(this, !1), e.promise
                },
                "catch": function(t) {
                ...
                Promise: s
            }), H(s, u), st(u), o = B[u], R(R.S + R.F * !p, u, {
                reject: function S(t) {
                    var n = d(this);
            ...
            R(R.S + R.F * !ft(function(t) {
                ...
                from: function h(t, n, e) {
                    var r, o, i, u, c = z(t),
                        ...
                        d = 0,
                        p = Q(c);
                    if (l && (a = I(a, 2 < f ? e : undefined, 2)), p == undefined || s == Array && $(p))
                        for (o = new s(r = w(c.length)); d < r; d++) lt(o, d, l ? a(c[d], d) : c[d]);
                    else
                        for (u = p.call(c), o = new s; !(i = u.next()).done; d++) lt(o, d, l ? Y(u, a, [i.value, d], !0) : i.value);
                    return o.length = d, o
                }
            })
        }), t(function() {
        ...
        pt = (t(function() {
            ...
            R(R.P + R.F * m(function() {
                ...
                slice: function a(t, n) {
                    ...
                    for (var o = x(t, e), i = x(n, e), u = w(i - o), c = Array(u), s = 0; s < u; s++) c[s] = "String" == r ? this.charAt(o + s) : this[o + s];
                    return c
                }
            })
        }), t(function() {
        ...
        mt = (t(function() {
            ...
            t.exports = [].copyWithin || function a(t, n, e) {
                var r = z(this),
                    ...
                    f = 1;
                for (u < i && i < u + s && (f = -1, u += s - 1, i += s - 1); 0 < s--;) u in r ? r[i] = r[u] : delete r[i], i += f, u += f;
                return r
            }
        })),
        bt = (t(function() {
            ...
            t.exports = function f(t, n, e) {
                for (var r = z(this), o = w(r.length), i = arguments.length, u = x(1 < i ? n : undefined, o), c = 2 < i ? e : undefined, s = c === undefined ? o : x(c, o); u < s;) r[u++] = t;
                return r
            }
        })),
        _t = (t(function() {
            ...
            t.exports = {
                getConstructor: function(t, i, e, r) {
                    var o = t(function(t, n) {
                        X(t, o, i, "_i"), t._t = i, t._i = G(null), t._f = undefined, t._l = undefined, t[f] = 0, n != undefined && Z(n, e, t[r], t)
                    });
                    return ct(o.prototype, {
                        clear: function u() {
                            for (var t = wt(this, i), n = t._i, e = t._f; e; e = e.n) e.r = !0, e.p && (e.p = e.p.n = undefined), delete n[e.i];
                        ...
                        "delete": function(t) {
                            ...
                            if (e) {
                                var r = e.n,
                                    o = e.p;
                                delete n._i[e.i], e.r = !0, o && (o.n = r), r && (r.p = o), n._f == e && (n._f = r), n._l == e && (n._l = o), n[f]--
                            }
                            return !!e
                        },
                ...
                def: function(t, n, e) {
                    ...
                    return i ? i.v = e : (t._l = i = {
                        ...
                        n: undefined,
                        r: !1
                    }, t._f || (t._f = i), r && (r.n = i), t[f]++, "F" !== o && (t._i[o] = i)), t
                },
                getEntry: a,
        ...
        St = t(function(t) {
            ...
            t.exports = {
                set: Object.setPrototypeOf || ("__proto__" in {} ? function(t, e, r) {
                    try {
                        (r = I(Function.call, At.f(Object.prototype, "__proto__").set, 2))(t, []), e = !(t instanceof Array)
                    } catch (n) {
                        e = !0
                    }
        ...
        Et = t(function(t) {
            ...
            t.exports = function(r, t, n, e, o, u) {
                ...
                if ("function" == typeof c && (u || f.forEach && !m(function() {
                    ...
                    })).prototype = f).constructor = c), (h || v) && (l("delete"), l("has"), o && l("get")), (v || p) && l(s), u && f.clear && delete f.clear
    ...
    ! function(t) {
        ...
        function p(t, n) {
            ...
            if (this.credentials = n.credentials || this.credentials || "omit", !n.headers && this.headers || (this.headers = new u(n.headers)), this.method = d(n.method || this.method || "GET"), this.mode = n.mode || this.mode || null, this.referrer = null, ("GET" === this.method || "HEAD" === this.method) && e) throw new TypeError("Body not allowed for GET or HEAD requests");
            this._initBody(e)
        }
        ...
        function v(t, n) {
            n || (n = {}), this.type = "default", this.status = n.status === undefined ? 200 : n.status, this.ok = 200 <= this.status && this.status < 300, this.statusText = "statusText" in n ? n.statusText : "OK", this.headers = new u(n.headers), this.url = n.url || "", this._initBody(t)
        }
        if (!t.fetch) {
            var m = {
            ...
            v.redirect = function(t, n) {
                ...
                return new Promise(function(e, t) {
                    ...
                    r.onload = function() {
                        ...
                        t(new TypeError("Network request failed"))
                    }, r.open(n.method, n.url, !0), "include" === n.credentials ? r.withCredentials = !0 : "omit" === n.credentials && (r.withCredentials = !1), "responseType" in r && m.blob && (
                        r.responseType = "blob"), n.headers.forEach(function(t, n) {
    ...
    var Ot = t(function(t, n) {
        ...
        Tt = t(function(t, n) {
            ...
            Object.defineProperty(n, "__esModule", {
                value: !0
            }), n["default"] = e, n.toggleFeatureCssClasses = r, n.appendDynamicCheckoutProductCss = o;
        ...
        Ft = t(function(t, n) {
            ...
            function r() {
                ...
                return new Promise(function(e) {
                    r() ? (window.Shopify.CartType = "cart_page", e()) : new MutationObserver(function(t, n) {
