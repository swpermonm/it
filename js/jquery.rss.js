(function($) {
    ...
    var RSS = function(target, url, options, callback) {
        ...
        this.options = $.extend({
            ...
            limit: null,
            key: null,
            layoutTemplate: '<div class="blog_listing">{entries}</div>',
            entryTemplate: '<div class="blog_item"><a href="{url}"><span class="blog_date">{date}</span> <span class="blog_title">{title}</span></a><div class="blog_body">{body}</div></div>',
            tokens: {},
            outputMode: 'json',
